...
export const BookmarkIcon = ({ isBookmarked }: BookmarkIconProps) => {
  return (
    <Icon size='sm' viewBox='0 0 56.868 56.868'>
      {isBookmarked
        ? <Path d='M53.251 6.242c0-3.324-2.684-6.053-6-6.126v-.01h-36.91a6.096 6.096 0 00-6.09 6.09v50.778l19-12.666 19 12.666V25.106h11V6.242z' />
